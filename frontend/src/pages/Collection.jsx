...
const Collection = () => { 
  ...
  useEffect(()=> {
    applyFilter()
  },[category, subCategory, products, sortType, showSearch, search, products])
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 border-t pt-10'>
      ...
      <div className='min-w-60'>
        <p onClick={()=> setShowFilter(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer gap-2'>FILTERS
          <img className={`h-3 sm:hidden ${showFilter ? "rotate-90" : ""} transition`} src={assets.dropdown_icon} alt="" />
        </p>
        {/* Category Filter */}
