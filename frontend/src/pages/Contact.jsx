...
const Contact = () => {
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row my-10 justify-center gap-10 mb-20">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <button className='px-8 py-4 border text-sm hover:bg-black hover:text-white transition-all duration-500'>Explore Jobs</button>
        </div>
      </div>
